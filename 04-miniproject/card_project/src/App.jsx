...
const App = () => {
  ...
  return (
    <div className='parent'>
     {jobOpenings.map(function(elms,index)
     {
      return <div key={index}>
          <Card company={elms.companyName} logo={elms.brandLogo}
      date={elms.datePosted} post={elms.post} tag={elms.tag1}
      tag3={elms.tag2} pay={elms.pay} location={elms.location}/>
         </div>
     })
    }
    </div>
